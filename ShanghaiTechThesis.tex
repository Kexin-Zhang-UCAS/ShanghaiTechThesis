...
\frontmatter\pagestyle{main}%frontmatter 后 include 的 separatepage 开始有页码且页码为罗马数字
    ...
    \tableofcontents
    \listoffigures\addcontentsline{toc}{chapter}{\listfigurename} %将插图目录加入全文目录
    \listoftables\addcontentsline{toc}{chapter}{\listtablename}  %将表格目录加入全文目录
    \listofalgorithms\addcontentsline{toc}{chapter}{\listalgorithmname} %将算法目录加入全文目录
    \include{separate-page/mainsymbol}
